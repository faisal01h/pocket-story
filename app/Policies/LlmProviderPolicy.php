...
class LlmProviderPolicy
{
    ...
    {
        return $user->can('llm.provider.manage');
    }
     ...
     */
    public function restore(User $user, LlmProvider $llmProvider): bool
    {
        return $user->can('llm.provider.manage');
    }
     ...
     */
    public function forceDelete(User $user, LlmProvider $llmProvider): bool
    {
        return false;
    }
}
